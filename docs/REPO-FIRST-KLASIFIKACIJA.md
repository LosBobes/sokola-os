...
| M03 Multi-tenancy | `ADAPT` | §5.2, §5.3, §8 koraci 3–5 i TEN-01/02/04/05 isporučeni (`app/domains/tenancy/`, migracije `e5f83a19d24b`, `f8c21e64b0a7`, 36 testova). Guard sada poredi sve tri verzije i ponovo dokazuje M06 članstvo. **Ostaje:** kontekst se bira role assignment-om umesto škola+workspace (F-24, čeka M05), composite tenant FK 4/46 (F-26), `student_login_authorization` globalan (F-27), TEN-Q01/Q02 i chooser UI |
