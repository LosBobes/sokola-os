...
| M06 Ljudi i članstva | `ADAPT` (§2.1, §2.4 urađeno) | `Person` proširen na §2.1 (birth_date, kontakt ciphertext + blind index, dedupe_status, version) i `school_person_profile` (§2.4) postoji — migracija `d2a95e13c7f4`, 23 testa. **Ostaje:** `SchoolMembership` usklađivanje sa §2.3 (membership_type, DRAFT/TERMINATED, datumi, is_first_activation), §2.2 sensitive identifier, §2.5–2.6 profili, §2.7 merge istorija, MEM-01..05 i PER/MRG komande |
