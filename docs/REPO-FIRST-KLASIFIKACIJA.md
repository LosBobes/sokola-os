...
| M06 Ljudi i članstva | `ADAPT` (§2.1, §2.3, §2.4 urađeno) | `Person` §2.1, `school_person_profile` §2.4 (migracija `d2a95e13c7f4`, 23 testa) i `school_membership` §2.3 sa MEM-01..05 tranzicijama (`app/domains/people/membership.py`, migracija `e6b1d47a2c98`, 20 testova). **Ostaje:** §2.2 sensitive identifier, §2.5–2.6 participant/staff profili, §2.7 merge istorija, PER/MRG komande, i HTTP površina za MEM komande |
